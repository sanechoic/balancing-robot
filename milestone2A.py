...
oled.draw_text(0, 10, 'Milestone 3: Dancing Steps')
...
try:
	...
	# Calculate instantaneous energy
			...
			max_energy = max(e_buf)  #Find Highest Epoch in buffer

			max_c = max_energy*M/sum_energy   # Convert to c

			BEAT_THRESHOLD = max(0.316*max_c,1)    #Use 0.3(Matlab value) of the maximum recent beat as Thesehold.
